      ...
      <section className="about-hero">
        <div className="about-hero-content">
          <h1 className="about-title">
            About <span className="highlight">LegalEaseAI</span>
          </h1>
      ...
      <section className="about-mission">
        <div className="container">
          <div className="mission-content">
            <h2>Our Mission</h2>
            <p>
              We are dedicated to creating innovative solutions that enhance your digital experience.
              Our team of experts works tirelessly to bring you the latest in technology and design.
            </p>
          </div>
        </div>
      </section>
